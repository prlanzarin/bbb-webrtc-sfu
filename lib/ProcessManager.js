...
module.exports = class ProcessManager {
  ...
  async start () {
    if (MULTIPROCESS) {
      const screenshareProcess = this.startProcess(SCREENSHARE_PATH);
      const videoProcess = this.startProcess(VIDEO_PATH);
      const audioProcess = this.startProcess(AUDIO_PATH);
      ...
      this.video = require('./video/VideoProcess');
      this.screensharej= require('./screenshare/ScreenshareProcess');
      this.audio = require('./audio/AudioProcess');
    }
