...
module.exports = class Room {
  ...
  setConferenceFloor (media) {
    let tentativeFloor;
    const shouldSetPreviousFloor = this._conferenceFloor
      && (this._previousConferenceFloors[0] == null
        || this._previousConferenceFloors[0].id !== this._conferenceFloor.id)

    if (shouldSetPreviousFloor) {
  ...
  setContentFloor (media) {
    const shouldSetPreviousFloor = this._contentFloor
      && (this._previousContentFloors[0] == null
        || this._previousContentFloors[0].id !== this._contentFloor.id)
